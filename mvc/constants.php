<?php
	...
	*/
	...
	//On définit les chemins
        define('PWD', '/var/www/clash-of-startup/'); //On défini le chemin de base du site
	define('HTTP_PWD', (isset($_SERVER['HTTPS']) ? 'https' : 'http') . '://' . (isset($_SERVER['SERVER_NAME']) ? $_SERVER['SERVER_NAME'] : 'localhost') . '/clash-of-startup/'); //On défini l'adresse url du site
